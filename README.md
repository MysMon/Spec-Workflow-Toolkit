...
複雑な機能開発を、専門AIエージェントの支援を受けながら段階的に進めるプラグイン。
...
| フェーズ | あなたがすること | システムがすること |
|----------|------------------|-------------------|
| 1. Discovery | 要件を説明する | 問題定義・制約を整理 |
| 2. Exploration | 結果を確認する | 既存コードを並列分析 |
| 3. Clarification | 質問に答える・仕様を承認 | 曖昧さを解消し仕様を作成 |
| 4. Architecture | 設計案を確認・承認 | 複数角度から設計を分析 |
| 5. Implementation | 進捗を確認する | 1機能ずつ実装 |
| 6. Review | 指摘事項に対応する | QA・セキュリティ検証 |
| 7. Summary | 結果を確認する | 変更内容を文書化 |
